...
subroutine prInitialize( this, domainSize, binSize, initialSmoothing, &
                ...
                select case(nd) 
                    ...
                    case (2)
                        if ( currentDim .eq. 1 ) then 
                            ...
                            kernelSDDatabase2 => this%kernelSDYDatabase
                            idDim2 = nd
                        end if
                    case (3)
                        kernelSDDatabase2 => this%kernelSDZDatabase
                        idDim2 = nd
                end select   
    ...
    subroutine prComputeNetRoughness2D( this, activeGridCells, curvatureBandwidth, &
        ...
        !$omp shared( this )                     &
        !$omp shared( activeGridCells )          &
        !$omp shared( idDim1, idDim2 )           &
        !$omp shared( kernelSDDatabase1 )        &
        !$omp shared( kernelSDDatabase2 )        & 
        !$omp shared( curvatureBandwidth )       &
        !$omp reduction( +:curvature1 )          &
        ...
        do n = 1, this%nComputeBins
            ...
            ! Assign pointer
            gc%kernelSD => kernelSDDatabase2( gc%kernelSDDBIndexes(idDim2) )
    ...
    subroutine prComputeNetRoughness3D( this, activeGridCells, curvatureBandwidth, &
        ...
        do n = 1, this%nComputeBins
            ...
            curvatureX( &
                    ...
                    gc%id(1), gc%id(2), gc%id(3) )*gc%kernelSDX%bmatrix(&
            ...
            curvatureY( &
                    ...
                    gc%id(1), gc%id(2), gc%id(3) )*gc%kernelSDY%bmatrix(&
            ...
            curvatureZ( &
                    ...
                    gc%id(1), gc%id(2), gc%id(3) )*gc%kernelSDZ%bmatrix(&
    ...
    subroutine prComputeDensityFromDatabaseFlat( this, densityEstimateGrid, nOptimizationLoops )
        ...
        do n = 1, this%nComputeBins
            ...
            if ( gc%transposeKernel ) then 
                ...
                !print * , ' GPKDE: WILL COMPUTE SPANS AND DEFINE BMATRIX'
                ! Determine spans
                call gc%kernel%ComputeGridSpans( gc%id, this%nBins, &
                    gc%kernelXGSpan, gc%kernelYGSpan, gc%kernelZGSpan, & 
                    gc%kernelXMSpan, gc%kernelYMSpan, gc%kernelZMSpan, &
                    this%dimensionMask )
                kernelMatrix => gc%kernel%bmatrix
                !kernelMatrix => gc%kernel%matrix
            end if 

                !print * , ' GPKDE: WILL COMPUTE DENSITY'
                !print *, ' KERNELMSPANX ', gc%kernelXMSpan
                !print *, ' KERNELMSPANY ', gc%kernelYMSpan
                !print *, ' KERNELMSPANZ ', gc%kernelZMSpan

             if ( gc%transposeKernel )   print *, 'KERNEL IS TRANSPOSED !!!!!!!!!!!!!'
